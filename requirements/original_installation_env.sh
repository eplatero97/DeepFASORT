...
python -c "import mmdet, mmcv; print(mmdet.__version__, mmcv.__version__)" # 1.6.2 2.28.2
git clone https://github.com/eplatero97/DeepFASORT
cd DeepFASORT
pip install -r requirements/build.txt
pip install -v -e .
pip install git+https://github.com/JonathonLuiten/TrackEval.git
python -c "import mmdet, mmcv, mmcls; print(mmdet.__version__, mmcv.__version__, mmcls.__version__)" # 1.6.2 2.28.2 0.25.0
pip install -U numpy # 1.24.2
